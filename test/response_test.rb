...
class ResponseTest < Minitest::Test
  ...
  def url_search_response_duplicate
    File.read(File.expand_path('url_search_response_duplicate.xml', __dir__))
  end

  def url_search_response_not_duplicate
    File.read(File.expand_path('url_search_response_not_duplicate.xml', __dir__))
  end

  def error_response
    File.read(File.expand_path('error_response.xml', __dir__))
  end
end
